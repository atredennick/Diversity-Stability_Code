...
| $\sigma_{c}$ | community response variance (see definition below) |
| $\sigma_{e}$ | environmental variance (equal among species) |
| $\sigma_{d}$ | demographic variance (equal among species) |
